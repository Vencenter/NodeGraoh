...
class Node(NodePlugin):
    ...
    def del_input(self, name='', multi_output=True, display_name=True):
        """
        del a output port the the node.
        Args:
        ...
        Returns:
            NodeGraphQt.interfaces.Port: the delete port object.
        """
        if name!='':
            self.item.del_input(name, multi_output, display_name)
